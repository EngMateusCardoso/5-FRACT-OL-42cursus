...
/*   Updated: 2022/07/12 06:39:55 by matcardo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	args_erro(void)
{
	...
	ft_putstr_fd("./fractol Multijulia N X.XXX X.XXX\n\n", 1);
	...
	ft_putstr_fd("\t./fractol Multijulia 3 0.4 0.002275\n", 1);
	ft_putstr_fd("\t./fractol Multijulia 3 0.64 0.33\n", 1);
	ft_putstr_fd("\t./fractol Multijulia 4 0.559 -0.0481\n", 1);
	ft_putstr_fd("\t./fractol Multijulia 5 0.736 -0.417355\n", 1);
	ft_putstr_fd("\t./fractol Multijulia 5 -0.90175 0.1211261\n", 1);
}
